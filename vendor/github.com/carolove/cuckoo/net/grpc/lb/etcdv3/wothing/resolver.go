...
func NewResolver(etcdAddr string, defaultSrvAddr ...string) resolver.Builder {
	return &etcdResolver{rawAddr: etcdAddr, defaultSrvAddr: defaultSrvAddr}
}
...
// NewResolver initialize an etcd client
// defaultSrvAddr
func NewRPCConn(etcdAddr, name string, defaultSrvAddr ...string) (conn *grpc.ClientConn, err error) {

	r := NewResolver(etcdAddr, defaultSrvAddr...)
	resolver.Register(r)
